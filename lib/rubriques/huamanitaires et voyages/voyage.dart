            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text("\u2022 Le logement directement à l'orphelinat."),
                  const Text("\u2022 Un repas par jour."),
                  const Text("\u2022 Les transports, y compris les trajets vers et depuis l'aéroport."),
                  ...
                  const Text("\u2022 JOUR 1 : Visite de petits et de grands puits + rencontre avec les villageois"),
                  const Text("\u2022 JOUR 2 : Distribution de denrées alimentaires aux villageois"),
                  const Text("\u2022 JOUR 3 : Journée à l'orphelinat (repas + distribution de jouets et/ou vêtements aux enfants)"),
                  const Text("\u2022 JOUR 4 : Participation à la construction d'un puits, d'une maison ou de plantations d'arbres"),
                  const Text("\u2022 JOUR 5 : Journée à la plage avec les orphelins"),
                  const Text("\u2022 JOUR 6 : Visite d'une école et d'un hôpital"),
