...
class AuriculotherapieFemme extends StatefulWidget {
  const AuriculotherapieFemme({super.key});

  @override
  State<AuriculotherapieFemme> createState() => _AuriculotherapieFemmeState();
}

class _AuriculotherapieFemmeState extends State<AuriculotherapieFemme> {
